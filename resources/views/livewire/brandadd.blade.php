<div>
    ...
    <div class="container">
        <div class="row">
            <form id="form-validation-2" class="form " action="{{route('userbranddata')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12 ">
                    <div id="amount-rows">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-2 col-md-12" >
                                    <label for="username" class="mb-2">Brand</label>
                                    <input class="form-control" type="text" id="rate" name="brandName" >
                                </div>
        ...
        <tbody class="" style="width: 100%;">
            ...
            <tr>
               ...
               <td>
                ...
                <a href="{{url('/userbranddelete/'.$item->id)}}"><button class="btn btn-outline-danger">Delete</button></a>
               </td>
            </tr>
            @endforeach
        </tbody>
