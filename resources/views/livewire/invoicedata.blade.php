                                                        ...
                                                        <div class="container border border-2 border-dark">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-8 text-center py-5" style="background-color:rgb(116, 201, 50);color:rgb(255,255,255)">
                                                                     <span><b class="display-6 fw-bold ">VANDE MILEAGER LUBRICANT</b></span>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-4 fs-6 border-top border-end border-2 border-dark p-3">
                                                                    <span><b>Contact : </b></span>+91 9829361615
                                                                </div>
                                                                 <div class="col-4 fs-6 border-top border-end border-2 border-dark p-3">
                                                                    <span><b>Email : </b></span>info@vandemileagerlubricant.com
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 border-top border-2 border-dark p-3">
                                                                    <span><b>Address : </b></span>Company corporate office Near by TTC
                                                        ...
                                                        <div class="container-fluid px-3 my-3">
                                                            <div class="row pb-0">
                                                               ...
                                                               <div class="row border border-bottom-0 border-2 border-dark py-2 px-2">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <span>
                                                                                <b>Consignee : </b> PRAGYA LUBRICANT
                                                                        </span><br>
                                                                        <span>
                                                                                Shop no.19, keshariya complex near sbi bank satpuliya ajmer road city ajmer Dist. Ajmer Rajasthan,305901
                                                                        </span><br>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <span>
                                                                                <b >Distributor Name : </b> PRAGYA LUBRICANT
                                                                        </span><br>
                                                                        <span>
                                                                                Shop no.19, keshariya complex near sbi bank satpuliya ajmer road city ajmer Dist. Ajmer Rajasthan,305901
                                                                        </span><br>
                                                                        ...
                                                                        <tbody>
                                                                            @php
                                                                                ...
                                                                                $productBulks = $productdata->qty
                                                                                    ...
                                                                                    : [];
                                                                                $totalAmounts = $productdata->prepcsamount
                                                                                    ? explode(
                                                                                        ',',
                                                                                        $productdata->prepcsamount,
                                                                                    )
                                                                                    : [];
                                                                            @endphp
                                                                            ...
                                                                            @foreach ($productNames as $index => $productName)
                                                                                <tr class="text-center">
                                                                                    ...
                                                                                    <td class="pt-3 border-end border-bottom-0">{{ $index + 1 }}</td>
                                                                                    <td scope="row"
                                                                                        class="ps-2 pt-3 border-end border-bottom-0">
                                                                                        {{ $productName }}</td>
                                                                                    <td class="ps-2 pt-3 border-end border-bottom-0" scope="row"
                                                                                        style="background-color:rgb(241, 241, 241)">
                                                                                        {{ $hsncode[$index] ?? '' }}
                                                                                    </td>
                                                                                    <td class="ps-2 pt-3 border-end border-bottom-0" style="background-color:rgb(241, 241, 241)">18 %</td>
                                                                                    <td class="ps-2 pt-3 border-end border-bottom-0" scope="row"
                                                                                        style="background-color:rgb(241, 241, 241)">
                                                                                        {{ $Productqty[$index] ?? '' }}
                                                                                    </td>
                                                                                    <td class="ps-2 pt-3 border-end border-bottom-0"
                                                                                        style="background-color:rgb(241, 241, 241)">
                                                                                        {{ $totalAmounts[$index] ?? '' }}
                                                                                    </td>
                                                                                    ...
                                                                                    <td class="ps-2 pt-3 border-bottom-0" scope="row"
                                                                                        style="background-color:rgb(241, 241, 241)">
                                                                                        {{ $amounts[$index] ?? '' }}
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <tr class="border-bottom border-top"
                                                                                ...
                                                                                <script>
                                                                                    ...
                                                                                    document.addEventListener("DOMContentLoaded", function() {
                                                                                          $totalDue = is_numeric($totalDue) ? $totalDue : 0;
