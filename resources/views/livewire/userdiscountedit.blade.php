<div>
    ...
    <div class="container">
        <div class="row">
            <form id="form-validation-2" class="form" action="{{ url('/discountedit/'.$discount->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12 ">
                    <div id="amount-rows">
                                        ...
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <select class="form-control" id="role" name="role">
                                                    ...
                                                    @foreach ($tab as $item)
                                                        <option value="{{ $item->id }}" {{ $discount->role == $item->id ? 'selected' : '' }}>
                                                            {{ $item->role }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-2 col-md-6">
                                                <label for="rate" class="mb-2">Commission Rate</label>
                                                <input class="form-control" type="text" id="rate" name="rate" value="{{ $discount->rate }}">
                                            </div>
