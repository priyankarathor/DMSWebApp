                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <tr>
                           ...
                           <td><a href="{{url('/onlineinvoiceget/'.$item->id)}}"><i class="fab fa-wpforms" style="border: 1px solid blue; padding:10px; border-radius:100%; color:green; font-size:22px; cursor: pointer;" ></i></a></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $item->id }}">
                                            ...
                                            <li>
                                                ...
                                                <a class="dropdown-item" href="{{ url('/onlineinvoicedelete/'.$item->id) }}" onclick="deleteItem('{{ url('/deleteinvoice/'.$item->id) }}')">
