<div>
    ...
    <div class="container">
        <div class="row">
            <form id="form-validation-2" class="form " action="{{route('categoryinsert')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12 ">
                    <h4 class="card-title mt-5 mb-3" style="color:green; font-size:30px;">Category Add</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2 col-md-6" style="display:none;">
                                    <label for="username" class="mb-2">Master</label>
                                    <input class="form-control" type="text" id="type" name="type" value="master">
                                </div>
                                <div class="mb-2 col-md-6" style="display:none;">
                                ...
                                <div class="mb-2 col-md-6">
                                    <label for="username" class="mb-2">Master Category</label>
                                    <input class="form-control" type="text" id="mastercategory" name="mastercategory">
                                </div>

                                <div class="mb-2 col-md-6">
                                    <label for="username" class="mb-2">Master Image</label>
    ...
    <div class="container mt-3">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row mt-2">
                    <div class="col-md-8">
                    <span class="card-title">Master category</span> &nbsp;&nbsp;          
                </div>
        ...
        <tbody class="">
            ...
            <tr>
               ...
               <td>
                <a href="{{url('/editmastercate/'.$item->id)}}" class="btn btn-outline-success">Edit</a>&nbsp;&nbsp;&nbsp;
                <a href="{{url('/categorydelete/delete/'.$item->id)}}" class="btn btn-outline-danger">Delete</a>
               </td>
            </tr>
            @endforeach
        </tbody>
