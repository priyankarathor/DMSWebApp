<div>
    ...
    <div class="container">
        <div class="row">
            <form id="form-validation-2" class="form " action="{{route('roledata')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12 ">
    ...
    <div class="container mt-3">
        ...
        <tbody class="" style="width: 100%;">
            ...
            <tr>
               ...
               <td>
                <a href="{{url('/roleedit/'.$item->id)}}"><button class="btn btn-outline-success">Edit</button></a>&nbsp;&nbsp;&nbsp;
               <a href="{{url('/roledel/'.$item->id)}}"><button class="btn btn-outline-danger">Delete</button></a>
               </td>
            </tr>
            @endforeach
        </tbody>
