<div>
    ...
    <div class="container">
        <div class="row">
            <form id="form-validation-2" class="form " action="{{url('/editmastercategorydata/'.$mastercate->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12 ">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2 col-md-6" style="display:none;">
                                    ...
                                    <input class="form-control" type="text" id="type" name="type" value="{{$mastercate->type}}">
                                </div>
                                <div class="mb-2 col-md-6" style="display:none;">
