            ...
            <div class="menu-body navbar-vertical">
                <div class="collapse navbar-collapse tab-content" id="sidebarCollapse">
                    ...
                    <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                        {{-- <li style="background-color: #115e0f; color:#fff !important; border-radius:50px; padding:10px 5px !improtant; text-align:center;" class="menu-label  text-primary font-12 ">M<span>ain</span><br><span class="font-10 text-secondary fw-normal">Unique Dashboard</span></li>                     --}}
                        ...
                        <li class="nav-item mt-3">
                            ...
                            <div class="collapse" id="sidebarquotation">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('quotationinvoicetable') }}">Quotation Table</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        @foreach ($getrole as $roledata)
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#distributter{{ $roledata->id }}" data-bs-toggle="collapse" role="button"
                                   aria-expanded="false" aria-controls="distributter{{ $roledata->id }}">
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            @if(isset($roledata->id))
                                                <a class="nav-link" href="{{ url('/stockorderlist/' . $roledata->id) }}">{{ $roledata->role }} Stock List</a>
                                            @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('userorder') }}"><i class="fas fa-list-alt menu-icon"></i><span>UserStock List</span></a>
                        </li>
                        <li class="nav-item">   
                            <a class="nav-link" href="{{route('getuserorder')}}"><i class="fas fa-shopping-cart menu-icon"></i><span>Orders</span></a>
                        </li>
                        <li class="nav-item">   
                            <a class="nav-link" href="{{route('history')}}"><i class="fas fa-tags menu-icon"></i><span>Sales</span></a>
                        </li>
                        <li class="nav-item">   
                            <a class="nav-link" href="{{route('userproducthistory')}}"><i class="fas fa-cart-arrow-down menu-icon"></i><span>purchase</span></a>
                        </li>
                    ...
                    <ul class="navbar-nav tab-pane" id="Extra" role="tabpanel">
                        <li>
                            <div class="update-msg text-center position-relative">
                                ...
                                <img src="{{ asset('assets/images/speaker-light.png') }}" alt=""
                                    class="" height="110">
                ...
                <!--<i class="ti ti-power font-16 me-1 align-text-bottom" class="btn btn-sm btn-danger underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ms-2"></i> Logout-->
                    ...
                    @auth
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="inline">
                            @csrf
                            <button type="submit" class="btn btn-sm btn-danger underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ms-2">
                            {{ __('Log Out') }}
                            </button>
                            {{-- {{$slot}} --}}
                        </form>
                        ...
                        <a href="{{ route('login') }}" class="btn btn-sm btn-success underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ms-2" style="color:#fff;">
                            {{ __('Login') }}
                        </a>
                        @endauth
            </a>
